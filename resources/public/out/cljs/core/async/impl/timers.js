...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_17618 = 0;while(true){
if((i_17618 < arr.length))
{(arr[i_17618] = null);
{
...
{var i_17625 = (self__.level + 1);while(true){
if((i_17625 <= (new_level + 1)))
{(update[i_17625] = self__.header);
{
var G__17626 = (i_17625 + 1);
i_17625 = G__17626;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_17627 = 0;while(true){
if((i_17627 <= self__.level))
{var links_17628 = (update[i_17627]).forward;if(((links_17628[i_17627]) === x__$1))
{(links_17628[i_17627] = (x__$1.forward[i_17627]));
{
var G__17629 = (i_17627 + 1);
i_17627 = G__17629;
continue;
}
} else
{{
var G__17630 = (i_17627 + 1);
i_17627 = G__17630;
continue;
}
}
