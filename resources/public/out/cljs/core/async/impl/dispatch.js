...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_17653 = 0;while(true){
var m_17654 = cljs.core.async.impl.dispatch.tasks.pop();if((m_17654 == null))
{} else
{m_17654.call(null);
if((count_17653 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__17655 = (count_17653 + 1);
count_17653 = G__17655;
continue;
}
} else
{}
