...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t17659 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t17659 = (function (val,box,meta17660){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t17659.cljs$lang$type = true;
cljs.core.async.impl.channels.t17659.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t17659";
cljs.core.async.impl.channels.t17659.cljs$lang$ctorPrWriter = (function (this__3835__auto__,writer__3836__auto__,opt__3837__auto__){return cljs.core._write.call(null,writer__3836__auto__,"cljs.core.async.impl.channels/t17659");
});
cljs.core.async.impl.channels.t17659.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t17659.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_17661){var self__ = this;
var _17661__$1 = this;return self__.meta17660;
});
cljs.core.async.impl.channels.t17659.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_17661,meta17660__$1){var self__ = this;
var _17661__$1 = this;return (new cljs.core.async.impl.channels.t17659(self__.val,self__.box,meta17660__$1));
});
cljs.core.async.impl.channels.__GT_t17659 = (function __GT_t17659(val__$1,box__$1,meta17660){return (new cljs.core.async.impl.channels.t17659(val__$1,box__$1,meta17660));
});
}
return (new cljs.core.async.impl.channels.t17659(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_17662 = self__.takes.pop();if((taker_17662 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_17662))
{var take_cb_17663 = cljs.core.async.impl.protocols.commit.call(null,taker_17662);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_17663,taker_17662){
return (function (){return take_cb_17663.call(null,null);
});})(take_cb_17663,taker_17662))
);
} else
{}
{
